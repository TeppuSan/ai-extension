...
#### 結果が表示されない
- **Web Store版**: ポップアップで結果が表示される場合があります
...
- **重要なポイント**: 
  - content.tsxが読み込まれていなくても、要約機能は正常に動作
  - 結果はポップアップで表示されるため、必要な情報は確実に取得可能
  - ページ内表示とポップアップ表示の両方に対応
- ポップアップが開かない場合は、拡張機能のアイコンをクリックして結果を確認
